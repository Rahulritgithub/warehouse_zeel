...
Revision ID: 6ceeeea01f2f
Revises: 35ca5c8b8619
Create Date: 2025-12-05 11:57:38.728502
...
revision: str = '6ceeeea01f2f'
down_revision: Union[str, Sequence[str], None] = '35ca5c8b8619'
...
def downgrade() -> None:
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('requests_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['storage_bin_rfid'], ['storage_bins.rfid'], name=op.f('transactions_storage_bin_rfid_fkey')),
    ...
    sa.ForeignKeyConstraint(['storage_bin_rfid'], ['storage_bins.rfid'], name=op.f('items_storage_bin_rfid_fkey')),
