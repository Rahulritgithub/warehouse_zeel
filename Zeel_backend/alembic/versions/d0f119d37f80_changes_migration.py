...
Revision ID: d0f119d37f80
Revises: 3b25884ebd4f
Create Date: 2025-12-04 14:31:06.144444
...
revision: str = 'd0f119d37f80'
down_revision: Union[str, Sequence[str], None] = '3b25884ebd4f'
...
def downgrade() -> None:
    ...
    sa.Column('storage_bin_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['rack_id'], ['racks.rack_id'], name='items_rack_id_fkey'),
    sa.ForeignKeyConstraint(['storage_bin_id'], ['storage_bins.id'], name='items_storage_bin_id_fkey'),
